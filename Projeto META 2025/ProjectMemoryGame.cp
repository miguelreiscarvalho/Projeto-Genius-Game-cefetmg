...
void partida() {
 ...
 for(j = 0; j <= step; j++) {
 switch(sequencia[j]) {
 case 0:  PORTB.RB0  = 1; Sound_Play(1055, 80); break;
 case 1:  PORTB.RB1  = 1; Sound_Play(975, 80); break;
 case 2:  PORTB.RB3  = 1; Sound_Play(900, 80); break;
 case 3:  PORTB.RB2  = 1; Sound_Play(825, 80); break;
 }
 delay_ms(480);
  PORTB.RB0  =  PORTB.RB1  =  PORTB.RB2  =  PORTB.RB3  = 0;
 delay_ms(360);
